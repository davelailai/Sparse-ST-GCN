...
clip_len = 100
graph = 'coco'
work_dir = './work_dirs_fight/dgstgcn/fight_hrnet/j_per10'
model = dict(
    # backbone=dict(
...
ann_file = 'data/fight_detection/annotations/fightVideos_k400_merge_717_modify.pkl'
...
train_pipeline = [
    ...
    dict(type='FormatGCNInput', num_person=10),
