...
work_dir = './work_dirs_sparse_adaptor/stgcn_sparse_whole/stgcn_pyskl_ntu60_xview_3dkp/j_sparse0.99'
# load_from='./work_dirs_sparse/stgcn_base/stgcn_pyskl_ntu60_xview_3dkp/j/latest.pth'
train_pipeline = [
