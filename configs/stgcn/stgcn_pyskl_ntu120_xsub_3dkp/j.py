...
work_dir = './work_dirs_sparse_adaptor/stgcn_sparse_whole/stgcn_pyskl_ntu120_xsub_3dkp/j_sparse0.6'
# load_from='./work_dirs_sparse/stgcn_base/stgcn_pyskl_ntu120_xsub_3dkp/j/latest.pth'
model = dict(
