_base_ = ['../CTRGCN_model.py']
model = dict(
    cls_head=dict(type='GCNHead', num_classes=120, in_channels=256))

work_dir = './work_dirs_TMM_final/dgstgcn_rebuttal/position_embedding/ctrgcn/ctrgcn_pyskl_ntu120_xset_3dkp/j_FF_MLP'
# load_from = './work_dirs_sparse/ctrgcn_base/ctrgcn_pyskl_ntu120_xset_3dkp/j/latest.pth'
