...
work_dir = './work_dirs_TMM_final/dgstgcn_rebuttal/position_embedding/ctrgcn/ctrgcn_pyskl_ntu60_xsub_3dkp/j_FF_MLP'
# load_from = './work_dirs_sparse/ctrgcn_base/ctrgcn_pyskl_ntu60_xsub_3dkp/j/latest.pth'
train_pipeline = [
