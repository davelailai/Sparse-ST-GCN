...
work_dir = './work_dirs_sparse_adaptor/ctrgcn_directly/ctrgcn_pyskl_ntu120_xsub_3dkp/j_sparse0.95'
# load_from = './work_dirs_sparse/ctrgcn_base/ctrgcn_pyskl_ntu120_xsub_3dkp/j/latest.pth'
